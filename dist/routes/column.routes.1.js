...
router.get('/columns/:id', _column2.default.readSingle);

//POST /api/v1/columns - Create a new column
router.post('/columns', _column2.default.create);

//PUT /api/v1/columns/:id - Update specific column
router.put('/columns/:id', _column2.default.update);

//DELETE /api/v1/columns/:id - Delete specific column
router.delete('/columns/:id', _column2.default.remove);
